...
class Transaction(models.Model):
	...
	soldToCode			   = models.ForeignKey(Unification, to_field = 'code', related_name = '+', blank = True, null = True)
	shipToCode			   = models.ForeignKey(Unification, to_field = 'code', blank = True, null = True)
	...
	salesRepresentative  = models.ForeignKey(SalesRepresentative, to_field = 'name', blank = True, null = True)
