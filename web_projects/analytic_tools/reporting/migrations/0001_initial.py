# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-02-09 12:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jdCode', models.ManyToManyField(blank=True, to='reporting.JD')),
                ('sapCode', models.ManyToManyField(blank=True, to='reporting.Sap')),
            ],
        ),
        migrations.CreateModel(
            name='Warehouse',
